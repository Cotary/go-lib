...
type BeforeHandler func(ctx context.Context, method *string, url *string, query map[string][]string, body interface{}, headers map[string]string) error

func AuthAppHandler(ctx context.Context, appID, secret string) BeforeHandler {
